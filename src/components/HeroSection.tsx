        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-white space-y-8 text-center">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-white/90 animate-fade-in max-w-3xl mx-auto">
              Ganhe <strong>10 cursos de IA</strong> + <strong>3 Pós-Graduações grátis</strong> (2 para você e 1 para
              presentear um amigo ou familiar). Acesso vitalício ao laboratório de IAs premium + Certificação emitida
              por faculdade.
            </p>
